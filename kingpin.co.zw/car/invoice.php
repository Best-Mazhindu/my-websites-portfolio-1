...
<td style="text-align:right;"><strong>Car Value</strong></td>
<td style="text-align:right;"><strong>Cover(4.5%)</strong></td>
</tr>
<?php
		$num=0;
...
<td style="color:red"class="text-right">
	<strong><?php echo '$US '.$row['premium']; ?></strong></td>
<td style="color:red"class="text-right">
	<strong><?php echo '$US '.$row['fee']; ?></strong></td>
<td style="background:white"><strong>Total Due</strong></td>
<td style="color:red;background:white"><strong><u><?php echo '$US '.$row['total']; ?></u></strong></td>
</tr> 
 <?php
		}
	?> 
